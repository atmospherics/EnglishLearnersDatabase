...
public class SwaggerDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            .title("English Learners Database")
            ...
            .termsOfServiceUrl("")
            .version("1.0.0")
            .contact(new Contact("","", "studentinfo@atmospherics.com"))
            .build();
    }
    ...
    public Docket customImplementation(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("com.atmos.EnglishLearnersDatabase.api"))
                    .build()
